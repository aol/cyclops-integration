...
public interface ObservableT<T> extends  FoldableTransformerSeq<T>{
   ...
   default <B> ObservableT<B> bind(Function<? super T,ObservableT<? extends B>> f){
	   return of(unwrap().map(observable-> observable.flatMap(a-> RxCyclops.toObservable(f.apply(a).unwrap().stream()))
					.<B>flatMap(a->a)));
   }
   /**
   ...
   public static <A> ObservableT<A> of(AnyM<? extends Observable<A>> monads){
       return Matchables.anyM(monads).visit(v-> ObservableTValue.of(v), s->ObservableTSeq.of(s));
   }
   ...
   public static <A> ObservableTSeq<A> fromIterable(
           Iterable<Observable<A>> iterableOfObservables) {
   ...
   public static <A> ObservableTSeq<A> fromPublisher(
           Publisher<Observable<A>> publisherOfObservables) {
   ...
   public static <A> ObservableTValue<A> fromIterableValue(
           Iterable<Observable<A>> iterableOfObservables) {
   ...
   default Observable<Observable<T>> observableOfObservable(){
	   return Observable.from(this.unwrap().stream());
   }
  ...
  */
 @Override
 default <U, R> ObservableT<R> zip(Iterable<? extends U> other, BiFunction<? super T, ? super U, ? extends R> zipper) {
 ...
 /* (non-Javadoc)
  * @see com.aol.cyclops.control.monads.transformers.values.TransformerSeq#zip(java.util.Observable.Observable)
  */
 @Override
 ...
 /* (non-Javadoc)
  * @see com.aol.cyclops.control.monads.transformers.values.TransformerSeq#zip3(java.util.Observable.Observable, java.util.Observable.Observable)
  */
 @Override
 ...
 /* (non-Javadoc)
  * @see com.aol.cyclops.control.monads.transformers.values.TransformerSeq#zip4(java.util.Observable.Observable, java.util.Observable.Observable, java.util.Observable.Observable)
  */
 @Override
 default <T2, T3, T4> ObservableT<Tuple4<T, T2, T3, T4>> zip4(Stream<? extends T2> second, Stream<? extends T3> third,
 ...
 /* (non-Javadoc)
  * @see com.aol.cyclops.control.monads.transformers.values.TransformerSeq#grouped(java.util.function.Function, java.util.Observable.Collector)
  */
 @Override
