...
public interface RxCyclops {
	...
	public interface ForObservableTransformer {
		...
		static <T1, T2, T3, R1, R2, R3, R> ObservableT<R> each4(ObservableT<? extends T1> value1,
			...
			return AnyM.ofSeq(For.anyM(fromObservableT(value1)).anyM(a -> fromObservableT(value2.apply(a))).anyM(a -> b -> fromObservableT(value3.apply(a, b)))
							.anyM(a -> b -> c -> fromObservableT(value4.apply(a, b, c))).yield4(yieldingFunction).unwrap())
					.unwrap();
		...
		static <T1, T2, T3, R1, R2, R3, R> ObservableT<R> each4(ObservableT<? extends T1> value1,
			...
			return AnyM.ofSeq(For.anyM(fromObservableT(value1)).anyM(a -> fromObservableT(value2.apply(a)))
					.anyM(a -> b -> fromObservableT(value3.apply(a, b))).anyM(a -> b -> c -> fromObservableT(value4.apply(a, b, c)))
					.filter(a -> b -> c -> d -> filterFunction.apply(a, b, c, d)).yield4(yieldingFunction).unwrap())
					.unwrap();
		...
		static <T1, T2, R1, R2, R> ObservableT<R> each3(ObservableT<? extends T1> value1,
			...
			return AnyM.ofSeq(For.anyM(fromObservableT(value1)).anyM(a -> fromObservableT(value2.apply(a)))
					.anyM(a -> b -> fromObservableT(value3.apply(a, b))).yield3(yieldingFunction).unwrap()).unwrap();
		...
		static <T1, T2, R1, R2, R> ObservableT<R> each3(ObservableT<? extends T1> value1,
			...
			return AnyM
					.ofSeq(For.anyM(fromObservableT(value1)).anyM(a -> fromObservableT(value2.apply(a))).anyM(a -> b -> fromObservableT(value3.apply(a, b)))
							.filter(a -> b -> c -> filterFunction.apply(a, b, c)).yield3(yieldingFunction).unwrap())
					.unwrap();
		...
		static <T, R1, R> ObservableT<R> each2(ObservableT<? extends T> value1, Function<? super T, ObservableT<R1>> value2,
				BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {

			return AnyM.ofSeq(For.anyM(fromObservableT(value1)).anyM(a -> fromObservableT(value2.apply(a))).yield2(yieldingFunction).unwrap())
					.unwrap();
			

		}

		static <T, R1, R> ObservableT<R> each2(ObservableT<? extends T> value1, Function<? super T, ? extends ObservableT<R1>> value2,
				BiFunction<? super T, ? super R1, Boolean> filterFunction,
				BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
