...
public class RxTest {
    ...
    public void observableT() {
        assertThat(ObservableTs.observableT(ReactiveSeq.of(Observable.just(1, 2, 3), Observable.just(10, 20, 30)))
                            .toListX(),
    ...
    public void observableTComp() {
        ...
        ObservableT<Tuple2<Integer, Integer>> stream = ObservableTs.forEach(ObservableT.fromIterable(ListX.of(Observable.range(1,
                                                                                                                                         10))),
