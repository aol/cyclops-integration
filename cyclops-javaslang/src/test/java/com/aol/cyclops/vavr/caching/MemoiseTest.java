package com.aol.cyclops.vavr.caching;

import static com.aol.cyclops.vavr.caching.Memoize.memoizeBiFunction;
import static com.aol.cyclops.vavr.caching.Memoize.memoizeCallable;
import static com.aol.cyclops.vavr.caching.Memoize.memoizeFunction;
import static com.aol.cyclops.vavr.caching.Memoize.memoizeFunction0;
import static com.aol.cyclops.vavr.caching.Memoize.memoizePredicate;
import static com.aol.cyclops.vavr.caching.Memoize.memoizeQuadFunction;
...
public class MemoiseTest {
    ...
    public void testMemoiseBiFunctionWithCache() {
        ...
        Function2<Integer, Integer, Integer> s = memoizeBiFunction((a, b) -> a + ++called, cacheable);
        assertThat(s.apply(0, 1), equalTo(1));
        assertThat(s.apply(0, 1), equalTo(1));
        assertThat(s.apply(0, 1), equalTo(1));
        assertThat(s.apply(1, 1), equalTo(3));
