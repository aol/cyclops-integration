...
import com.aol.cyclops.vavr.hkt.typeclasses.instances.FutureInstances;
...
public class FuturesTest {
    ...
    public void unit(){
        ...
        FutureKind<String> opt = FutureInstances.unit()
                                            .unit("hello")
    ...
    public void functor(){
        ...
        FutureKind<Integer> opt = FutureInstances.unit()
                                     .unit("hello")
    ...
    public void applicative(){
        ...
        FutureKind<Function<Integer,Integer>> optFn =FutureInstances.unit().unit(Lambda.l1((Integer i) ->i*2)).convert(FutureKind::narrowK);
    ...
    public void monadSimple(){
       FutureKind<Integer> opt  = FutureInstances.monad()
    ...
    public void monadPlus(){
        FutureKind<Integer> opt = FutureInstances.<Integer>monadPlus()
    ...
    public void monadPlusNonEmpty(){
        ...
        FutureKind<Integer> opt = FutureInstances.<Integer>monadPlus(m)
    ...
    public void traverse(){
       MaybeType<Higher<FutureKind.µ, Integer>> res = FutureInstances.traverse()
