...
public class ComprehensionTest {
    ...
    public void optionalTest() {
        ...
        assertTrue(Javaslang.ForValue.each2(Option.of(10), a -> Option.none(), (a, b) -> "failed")
                                     .isEmpty());
    }
    ...
    public void option2Test() {
        ...
        assertThat(Javaslang.ForValue.each2(Option.of(10), a -> Option.<Integer> of(a + 20), (a, b) -> a + b)
                                     .get(),
                   equalTo(40));
    }
    ...
    public void generate() {
        ...
        String s = Javaslang.ForTraversable.each2(List.of(1, 2, 3), a -> List.<Integer> of(a + 10), Tuple::tuple)
                                           .toString();
    ...
    public void generateStream() {
        ...
        String s = Javaslang.ForTraversable.each2(Stream.of(1, 2, 3), a -> Stream.<Integer> of(a + 10), Tuple::tuple)
                                           .toString();
    ...
    public void generateListStream() {
        ...
        String s = Javaslang.ForTraversable.each2(List.of(1, 2, 3), a -> Stream.<Integer> of(a + 10), Tuple::tuple)
                                           .toString();
