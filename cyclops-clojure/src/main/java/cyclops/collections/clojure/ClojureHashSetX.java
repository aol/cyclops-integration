...
public class ClojureHashSetX<T> extends AbstractSet<T>implements PersistentSet<T>,Unwrapable {
    ...
    public static <T> Reducer<PersistentSet<T>> toPSet() {
        return Reducer.<PersistentSet<T>> of(ClojureHashSetX.emptyPSet(), (final PersistentSet<T> a) -> b -> a.plusAll(b),
