...
public class ClojureTreeSetX<T> extends AbstractSet<T>implements PersistentSortedSet<T> ,Unwrapable{
     ...
     */
    public static <U, T extends Comparable<? super T>> LazyPersistentSortedSetX<T> unfold(U seed,
     ...
     */
    public static <T extends Comparable<? super T>> LazyPersistentSortedSetX<T> iterate(long limit, final T seed,
    ...
    public static <T> LazyPersistentSortedSetX<T> PersistentSortedSet(PersistentTreeSet q) {
    ...
    @SafeVarargs
    public static <T extends Comparable<? super T>> LazyPersistentSortedSetX<T> PersistentSortedSet(Comparator<T> comp,T... elements) {
