...
public class PVectorTest {
    ...
    public void setup(){
       ...
       test = ClojurePVector.empty();
     
    }
    
    @Test
    public void empty(){
        assertThat(TreePVector.empty(),equalTo(ClojurePVector.empty()));
    }
    @Test
    public void singleton(){
        assertThat(TreePVector.singleton(1),equalTo(ClojurePVector.singleton(1)));
    }
