...
public class PSetTest {
    ...
    public void setup(){
       ...
       test = ClojureHashPSet.empty();
     
    }
    
    @Test
    public void empty(){
        assertThat(HashTreePSet.empty(),equalTo(ClojureHashPSet.empty()));
    }
    @Test
    public void singleton(){
        assertThat(HashTreePSet.singleton(1),equalTo(ClojureHashPSet.singleton(1)));
    }
    ...
    public void plusAllScala(){
        assertThat(org.plusAll(Arrays.asList(1,2,3)).plusAll(Arrays.asList(5,6,7)),
                   equalTo(test.plusAll(ClojureHashPSet.of(1,2,3)).plusAll(Arrays.asList(5,6,7))));
    }
