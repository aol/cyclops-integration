...
public class ScalaListX<T> extends AbstractList<T>implements PersistentList<T>, HasScalaCollection<T>, Unwrapable {
    ...
    public static <T> LazyLinkedListX<T> from(List<T> q) {
        return fromPersistentList(new ScalaListX<>(q), toPersistentList());
    }
    ...
    public static <T> LazyLinkedListX<T> fromStream(Stream<T> stream) {
        return new LazyLinkedListX<T>(null,ReactiveSeq.fromStream(stream), toPersistentList(), gen, Evaluation.LAZY);
    }
     ...
     * <pre>
     * {@code
     * PersistentList<Integer> q = PersistentList.<Integer>toPersistentList()
    ...
    public static <T> Reducer<PersistentList<T>> toPersistentList() {
        return Reducer.<PersistentList<T>> of(ScalaListX.emptyPersistentList(), (final PersistentList<T> a) -> b -> a.plusAll(b),
    ...
    public static <T> LazyLinkedListX<T> lazyList(List<T> vector){
        return fromPersistentList(fromList(vector), toPersistentList());
    }

    private static <T> LazyLinkedListX<T> fromPersistentList(PersistentList<T> s, Reducer<PersistentList<T>> pStackReducer) {
        return new LazyLinkedListX<T>(s,null, pStackReducer,gen, Evaluation.LAZY);
    }


    public static <T> ScalaListX<T> emptyPersistentList() {
    ...
    public static <T> LazyLinkedListX<T> empty() {
        return fromPersistentList(new ScalaListX<>(
                                                        List$.MODULE$.empty()),
                                      toPersistentList());
    }
    ...
    public static <T> LazyLinkedListX<T> PersistentList(List<T> q) {
        return fromPersistentList(new ScalaListX<T>(
                                                         q),
                                      toPersistentList());
    }
    ...
    public static <T> LinkedListX<T> copyFromCollection(CollectionX<T> vec) {
        ...
        return fromPersistentList(fromList(list),toPersistentList());
