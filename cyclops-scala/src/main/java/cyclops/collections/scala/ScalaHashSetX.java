...
public class ScalaHashSetX<T> extends AbstractSet<T>implements PersistentSet<T>, HasScalaCollection<T>, Unwrapable {
    ...
    public static <T> Reducer<PersistentSet<T>> toPSet() {
        return Reducer.<PersistentSet<T>> of(ScalaHashSetX.emptyPSet(), (final PersistentSet<T> a) -> b -> a.plusAll(b),
