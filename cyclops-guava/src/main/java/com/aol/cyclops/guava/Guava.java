...
public class Guava {
	...
	public interface ForOptional {
		...
		static <T, R1, R> Optional<R> each2(Optional<? extends T> value1, Function<? super T, ? extends Optional<R1>> value2,
	...
	public interface ForFluentIterable {
		...
		static <T, R1, R> FluentIterable<R> each2(FluentIterable<? extends T> value1, Function<? super T, FluentIterable<R1>> value2,
				BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
		...
		static <T, R1, R> FluentIterable<R> each2(FluentIterable<? extends T> value1, Function<? super T, ? extends FluentIterable<R1>> value2,
				BiFunction<? super T, ? super R1, Boolean> filterFunction,
				BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
