...
public class PartitionAndSplittingRSTest {
	...
	public void testSplitAtHead() {
		...
		assertEquals(asList(), Fluxs.of(1).splitAtHead().v2.toList());

		assertEquals(Optional.empty(), of().splitAtHead().v1);
		assertEquals(asList(), Fluxs.of().splitAtHead().v2.toList());

		assertEquals(Optional.of(1), Fluxs.of(1).splitAtHead().v1);

		assertEquals(Optional.of(1), Fluxs.of(1, 2).splitAtHead().v1);
		assertEquals(asList(2), Fluxs.of(1, 2).splitAtHead().v2.toList());

		assertEquals(Optional.of(1), Fluxs.of(1, 2, 3).splitAtHead().v1);
		assertEquals(Optional.of(2), Fluxs.of(1, 2, 3).splitAtHead().v2.splitAtHead().v1);
		assertEquals(Optional.of(3), Fluxs.of(1, 2, 3).splitAtHead().v2.splitAtHead().v2.splitAtHead().v1);
		assertEquals(asList(2, 3), Fluxs.of(1, 2, 3).splitAtHead().v2.toList());
		assertEquals(asList(3), Fluxs.of(1, 2, 3).splitAtHead().v2.splitAtHead().v2.toList());
		assertEquals(asList(), Fluxs.of(1, 2, 3).splitAtHead().v2.splitAtHead().v2.splitAtHead().v2.toList());
	}
