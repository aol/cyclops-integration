...
public class ReactorPipesTest {
    ReactorPipes<String,String> pipes;
   
    @Before
    public void setup() {
        pipes = ReactorPipes.of(new HashMap<>());
    }
    
    @Test
    public void evalIssue(){
        
        ReactorPipes<String, Integer> bus = ReactorPipes.of();
    ...
    public void nextAsync(){
        ...
        pipes.push("hello", "world2");
        q.close();
        assertThat(pipes.oneOrErrorAsync("hello", ex).block(),
