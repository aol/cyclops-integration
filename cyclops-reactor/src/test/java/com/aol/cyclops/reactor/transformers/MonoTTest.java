...
public class MonoTTest implements Printable {
    ...
    MonoTValue<Integer> just;
    MonoTValue<Integer> none;
    MonoTValue<Integer> one;
    @Before
    ...
    public void testMkString() {
        assertThat(just.mkString(),equalTo("MonoTValue[10]"));
        assertThat(none.mkString(),equalTo("MonoTValue[]"));
    }
