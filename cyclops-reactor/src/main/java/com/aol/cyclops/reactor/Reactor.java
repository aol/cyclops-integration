...
public interface Reactor {
	...
	public interface ForFluxTransformer {
		...
		static <T1, T2, T3, R1, R2, R3, R> FluxT<R> each4(FluxT<? extends T1> value1,
			...
			return AnyM.ofSeq(For.anyM(fromFluxT(value1)).anyM(a -> fromFluxT(value2.apply(a))).anyM(a -> b -> fromFluxT(value3.apply(a, b)))
							.anyM(a -> b -> c -> fromFluxT(value4.apply(a, b, c))).yield4(yieldingFunction).unwrap())
					.unwrap();
		...
		static <T1, T2, T3, R1, R2, R3, R> FluxT<R> each4(FluxT<? extends T1> value1,
			...
			return AnyM.ofSeq(For.anyM(fromFluxT(value1)).anyM(a -> fromFluxT(value2.apply(a)))
					.anyM(a -> b -> fromFluxT(value3.apply(a, b))).anyM(a -> b -> c -> fromFluxT(value4.apply(a, b, c)))
					.filter(a -> b -> c -> d -> filterFunction.apply(a, b, c, d)).yield4(yieldingFunction).unwrap())
					.unwrap();
		...
		static <T1, T2, R1, R2, R> FluxT<R> each3(FluxT<? extends T1> value1,
			...
			return AnyM.ofSeq(For.anyM(fromFluxT(value1)).anyM(a -> fromFluxT(value2.apply(a)))
					.anyM(a -> b -> fromFluxT(value3.apply(a, b))).yield3(yieldingFunction).unwrap()).unwrap();
		...
		static <T1, T2, R1, R2, R> FluxT<R> each3(FluxT<? extends T1> value1,
			...
			return AnyM
					.ofSeq(For.anyM(fromFluxT(value1)).anyM(a -> fromFluxT(value2.apply(a))).anyM(a -> b -> fromFluxT(value3.apply(a, b)))
							.filter(a -> b -> c -> filterFunction.apply(a, b, c)).yield3(yieldingFunction).unwrap())
					.unwrap();
		...
		static <T, R1, R> FluxT<R> each2(FluxT<? extends T> value1, Function<? super T, FluxT<R1>> value2,
			...
			return AnyM.ofSeq(For.anyM(fromFluxT(value1)).anyM(a -> fromFluxT(value2.apply(a))).yield2(yieldingFunction).unwrap())
					.unwrap();
