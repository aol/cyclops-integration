...
public class LazyListX<T> extends AbstractFluentCollectionX<T> implements ListX<T> {
    ...
    public LazyListX(List<T> list,Collector<T,?,List<T>> collector){
     ...
     */
    @Override
    public <U> ListX<Tuple2<T, U>> zip(Iterable<? extends U> other) {
     ...
     */
    @Override
    public <U, R> ListX<R> zip(Iterable<? extends U> other, BiFunction<? super T, ? super U, ? extends R> zipper) {
     ...
     */
    @Override
    public <U> ListX<U> scanLeft(U seed, BiFunction<? super U, ? super T, ? extends U> function) {
     ...
     */
    @Override
    public <U> ListX<U> scanRight(U identity, BiFunction<? super T, ? super U, ? extends U> combiner) {
     ...
     */
    @Override
    public <U> ListX<Tuple2<T, U>> zip(Seq<? extends U> other) {
     ...
     */
    @Override
    public <T2, T3, T4> ListX<Tuple4<T, T2, T3, T4>> zip4(Stream<? extends T2> second, Stream<? extends T3> third,
            Stream<? extends T4> fourth) {
       
        return (ListX)super.zip4(second, third, fourth);
    }
    /* (non-Javadoc)
     ...
     */
    @Override
    public ListX<T> onEmptyGet(Supplier<? extends T> supplier) {
     ...
     */
    @Override
    public <X extends Throwable> ListX<T> onEmptyThrow(Supplier<? extends X> supplier) {
     ...
     */
    @Override
    public <U> ListX<U> ofType(Class<? extends U> type) {
     ...
     */
    @Override
    public ListX<T> removeAll(Stream<? extends T> stream) {
     ...
     */
    @Override
    public ListX<T> removeAll(Seq<? extends T> stream) {
     ...
     */
    @Override
    public ListX<T> removeAll(Iterable<? extends T> it) {
     ...
     */
    @Override
    public ListX<T> retainAll(Iterable<? extends T> it) {
     ...
     */
    @Override
    public ListX<T> retainAll(Stream<? extends T> stream) {
     ...
     */
    @Override
    public ListX<T> retainAll(Seq<? extends T> stream) {
     ...
     */
    @Override
    public <U> ListX<U> cast(Class<? extends U> type) {
