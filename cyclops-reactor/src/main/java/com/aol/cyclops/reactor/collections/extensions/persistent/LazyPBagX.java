...
public class LazyPBagX<T> extends AbstractFluentCollectionX<T> implements PBagX<T> {
     ...
     * @return LazyPStackX
     */
    public static <T> LazyPBagX<T> fromStreamS(Stream<T> stream){
        return new LazyPBagX<T>(Flux.from(ReactiveSeq.fromStream(stream)));
    }
    /**
     ...
     * @return Range ListX
     */
    public static LazyPBagX<Integer> range(int start, int end) {
     ...
     * @return Range ListX
     */
    public static LazyPBagX<Long> rangeLong(long start, long end) {
     ...
     */
    public static <U, T> LazyPBagX<T> unfold(U seed, Function<? super U, Optional<Tuple2<T, U>>> unfolder) {
     ...
     */
    public static <T> LazyPBagX<T> generate(long limit, Supplier<T> s) {
     ...
     */
    public static <T> LazyPBagX<T> iterate(long limit, final T seed, final UnaryOperator<T> f) {
     ...
     */
    public static <T> Collector<T, ?, LazyPBagX<T>> lazyListXCollector() {
        return Collectors.toCollection(() -> LazyPBagX.of());
    }
     ...
     */
    public static <T> LazyPBagX<T> empty() {
     ...
     */
    @SafeVarargs
    public static <T> LazyPBagX<T> of(T... values) {
     ...
     */
    public static <T> LazyPBagX<T> singleton(T value) {
        return LazyPBagX.<T> of(value);
    }
     ...
     * @return ListX
     */
    public static <T> LazyPBagX<T> fromPublisher(Publisher<? extends T> publisher) {
     ...
     */
    public static <T> LazyPBagX<T> fromIterable(Iterable<T> it) {
        return fromIterable(Reducers.toPBag(), it);
    }
     ...
     */
    public static <T> LazyPBagX<T> fromIterable(Reducer<PBag<T>> collector, Iterable<T> it) {
        if (it instanceof LazyPBagX)
            return (LazyPBagX<T>) it;
       
        if (it instanceof PBag)
            return new LazyPBagX<T>(
                                    (PBag<T>) it, collector);
    ...
    private LazyPBagX(PBag<T> list,Reducer<PBag<T>> collector){
        this.lazy = new PersistentLazyCollection<T,PBag<T>>(list,null,collector);
        this.collector=  collector;
    }
    private LazyPBagX(boolean efficientOps,PBag<T> list,Reducer<PBag<T>> collector){
        this.lazy = new PersistentLazyCollection<T,PBag<T>>(list,null,collector);
        this.collector=  collector;
    }
    
    private LazyPBagX(PBag<T> list){
        this.collector = Reducers.toPBag();
        this.lazy = new PersistentLazyCollection<T,PBag<T>>(list,null,Reducers.toPBag());
    }
    private LazyPBagX(Flux<T> stream,Reducer<PBag<T>> collector){
        this.collector = collector;
        this.lazy = new PersistentLazyCollection<>(null,stream,Reducers.toPBag());
    }
    private LazyPBagX(Flux<T> stream){
        this.collector = Reducers.toPBag();
        this.lazy = new PersistentLazyCollection<>(null,stream,collector);
    }
    private LazyPBagX(){
        this.collector = Reducers.toPBag();
        this.lazy = new PersistentLazyCollection<>((PBag)this.collector.zero(),null,collector);
    }
    ...
    public Spliterator<T> spliterator() {
        return getBag().spliterator();
    }
   
    /**
     * @return PQueue
     */
    private PBag<T> getBag() {
        return lazy.get();
    }
     ...
     */
    @Override
    public <X> LazyPBagX<X> stream(Flux<X> stream){
        return new LazyPBagX<X>(stream);
    }
     ...
     */
    @Override
    public LazyPBagX<T> combine(BiPredicate<? super T, ? super T> predicate, BinaryOperator<T> op) {
       
        return (LazyPBagX<T>)super.combine(predicate, op);
    }
     ...
     */
    @Override
    public LazyPBagX<T> reverse() {
       
        return(LazyPBagX<T>)super.reverse();
    }
     ...
     */
    @Override
    public LazyPBagX<T> filter(Predicate<? super T> pred) {
       
        return (LazyPBagX<T>)super.filter(pred);
    }
     ...
     */
    @Override
    public <R> LazyPBagX<R> map(Function<? super T, ? extends R> mapper) {
       
        return (LazyPBagX<R>)super.map(mapper);
    }
     ...
     */
    @Override
    public <R> LazyPBagX<R> flatMap(Function<? super T, ? extends Iterable<? extends R>> mapper) {
       return (LazyPBagX<R>)super.flatMap(mapper);
    }
     ...
     */
    @Override
    public LazyPBagX<T> limit(long num) {
       return (LazyPBagX<T>)super.limit(num);
    }
     ...
     */
    @Override
    public LazyPBagX<T> skip(long num) {
       return (LazyPBagX<T>)super.skip(num);
    }
     ...
     */
    @Override
    public LazyPBagX<T> takeRight(int num) {
       return (LazyPBagX<T>)super.takeRight(num);
    }
     ...
     */
    @Override
    public LazyPBagX<T> dropRight(int num) {
       return (LazyPBagX<T>)super.dropRight(num);
    }
     ...
     */
    @Override
    public LazyPBagX<T> takeWhile(Predicate<? super T> p) {
       return (LazyPBagX<T>)super.takeWhile(p);
    }
     ...
     */
    @Override
    public LazyPBagX<T> dropWhile(Predicate<? super T> p) {
       return (LazyPBagX<T>)super.dropWhile(p);
    }
     ...
     */
    @Override
    public LazyPBagX<T> takeUntil(Predicate<? super T> p) {
       return (LazyPBagX<T>)super.takeUntil(p);
    }
     ...
     */
    @Override
    public LazyPBagX<T> dropUntil(Predicate<? super T> p) {
       return(LazyPBagX<T>)super.dropUntil(p);
    }
     ...
     */
    @Override
    public <R> LazyPBagX<R> trampoline(Function<? super T, ? extends Trampoline<? extends R>> mapper) {
       return (LazyPBagX<R>)super.trampoline(mapper);
    }
     ...
     */
    @Override
    public LazyPBagX<T> slice(long from, long to) {
       return (LazyPBagX<T>)super.slice(from, to);
    }
     ...
     */
    @Override
    public LazyPBagX<ListX<T>> grouped(int groupSize) {
       
        return (LazyPBagX<ListX<T>>)super.grouped(groupSize);
    }
     ...
     */
    @Override
    public <K, A, D> LazyPBagX<Tuple2<K, D>> grouped(Function<? super T, ? extends K> classifier,
            Collector<? super T, A, D> downstream) {
       
        return (LazyPBagX)super.grouped(classifier, downstream);
    }
     ...
     */
    @Override
    public <K> LazyPBagX<Tuple2<K, Seq<T>>> grouped(Function<? super T, ? extends K> classifier) {
       
        return (LazyPBagX)super.grouped(classifier);
    }
     ...
     */
    @Override
    public <U> LazyPBagX<Tuple2<T, U>> zip(Iterable<? extends U> other) {
       
        return (LazyPBagX)super.zip(other);
    }
     ...
     */
    @Override
    public <U, R> LazyPBagX<R> zip(Iterable<? extends U> other, BiFunction<? super T, ? super U, ? extends R> zipper) {
       
        return (LazyPBagX<R>)super.zip(other, zipper);
    }
     ...
     */
    @Override
    public LazyPBagX<ListX<T>> sliding(int windowSize) {
       
        return (LazyPBagX<ListX<T>>)super.sliding(windowSize);
    }
     ...
     */
    @Override
    public LazyPBagX<ListX<T>> sliding(int windowSize, int increment) {
       
        return (LazyPBagX<ListX<T>>)super.sliding(windowSize, increment);
    }
     ...
     */
    @Override
    public LazyPBagX<T> scanLeft(Monoid<T> monoid) {
       
        return (LazyPBagX<T>)super.scanLeft(monoid);
    }
     ...
     */
    @Override
    public <U> LazyPBagX<U> scanLeft(U seed, BiFunction<? super U, ? super T, ? extends U> function) {
       
        return (LazyPBagX<U>) super.scanLeft(seed, function);
    }
     ...
     */
    @Override
    public LazyPBagX<T> scanRight(Monoid<T> monoid) {
       
        return (LazyPBagX<T>)super.scanRight(monoid);
    }
     ...
     */
    @Override
    public <U> LazyPBagX<U> scanRight(U identity, BiFunction<? super T, ? super U, ? extends U> combiner) {
       
        return (LazyPBagX<U>)super.scanRight(identity, combiner);
    }
     ...
     */
    @Override
    public <U extends Comparable<? super U>> LazyPBagX<T> sorted(Function<? super T, ? extends U> function) {
       
        return (LazyPBagX<T>)super.sorted(function);
    }
     ...
     */
    @Override
    public LazyPBagX<T> plusLazy(T e) {
       
        return (LazyPBagX<T>)super.plusLazy(e);
    }
     ...
     */
    @Override
    public LazyPBagX<T> plusAllLazy(Collection<? extends T> list) {
       
        return (LazyPBagX<T>)super.plusAllLazy(list);
    }
     ...
     */
    @Override
    public LazyPBagX<T> minusLazy(Object e) {
       
        return (LazyPBagX<T>)super.minusLazy(e);
    }
     ...
     */
    @Override
    public LazyPBagX<T> minusAllLazy(Collection<?> list) {
       
        return (LazyPBagX<T>)super.minusAllLazy(list);
    }
     ...
     */
    @Override
    public LazyPBagX<T> cycle(int times) {
        return (LazyPBagX<T>)super.cycle(times);
    }
     ...
     */
    @Override
    public LazyPBagX<T> cycle(Monoid<T> m, int times) {
        return (LazyPBagX<T>)super.cycle(m,times);
    }
     ...
     */
    @Override
    public LazyPBagX<T> cycleWhile(Predicate<? super T> predicate) {
        return (LazyPBagX<T>)super.cycleWhile(predicate);
    }
     ...
     */
    @Override
    public LazyPBagX<T> cycleUntil(Predicate<? super T> predicate) {
        return (LazyPBagX<T>)super.cycleUntil(predicate);
    }
     ...
     */
    @Override
    public <U> LazyPBagX<Tuple2<T, U>> zip(Seq<? extends U> other) {
     ...
     */
    @Override
    public <S, U> LazyPBagX<Tuple3<T, S, U>> zip3(Stream<? extends S> second, Stream<? extends U> third) {
       
        return (LazyPBagX)super.zip3(second, third);
    }
     ...
     */
    @Override
    public <T2, T3, T4> LazyPBagX<Tuple4<T, T2, T3, T4>> zip4(Stream<? extends T2> second, Stream<? extends T3> third,
            Stream<? extends T4> fourth) {
       
        return (LazyPBagX)super.zip4(second, third, fourth);
    }
     ...
     */
    @Override
    public LazyPBagX<Tuple2<T, Long>> zipWithIndex() {
       
        return (LazyPBagX<Tuple2<T, Long>>)super.zipWithIndex();
    }
     ...
     */
    @Override
    public LazyPBagX<T> distinct() {
       
        return (LazyPBagX<T>)super.distinct();
    }
     ...
     */
    @Override
    public LazyPBagX<T> sorted() {
       
        return (LazyPBagX<T>)super.sorted();
    }
     ...
     */
    @Override
    public LazyPBagX<T> sorted(Comparator<? super T> c) {
       
        return (LazyPBagX<T>)super.sorted(c);
    }
     ...
     */
    @Override
    public LazyPBagX<T> skipWhile(Predicate<? super T> p) {
       
        return (LazyPBagX<T>)super.skipWhile(p);
    }
     ...
     */
    @Override
    public LazyPBagX<T> skipUntil(Predicate<? super T> p) {
       
        return (LazyPBagX<T>)super.skipUntil(p);
    }
     ...
     */
    @Override
    public LazyPBagX<T> limitWhile(Predicate<? super T> p) {
       
        return (LazyPBagX<T>)super.limitWhile(p);
    }
     ...
     */
    @Override
    public LazyPBagX<T> limitUntil(Predicate<? super T> p) {
       
        return (LazyPBagX<T>)super.limitUntil(p);
    }
     ...
     */
    @Override
    public LazyPBagX<T> intersperse(T value) {
       
        return (LazyPBagX<T>)super.intersperse(value);
    }
     ...
     */
    @Override
    public LazyPBagX<T> shuffle() {
       
        return (LazyPBagX<T>)super.shuffle();
    }
     ...
     */
    @Override
    public LazyPBagX<T> skipLast(int num) {
       
        return (LazyPBagX<T>)super.skipLast(num);
    }
     ...
     */
    @Override
    public LazyPBagX<T> limitLast(int num) {
       
        return (LazyPBagX<T>)super.limitLast(num);
    }
     ...
     */
    @Override
    public LazyPBagX<T> onEmpty(T value) {
       
        return (LazyPBagX<T>)super.onEmpty(value);
    }
     ...
     */
    @Override
    public LazyPBagX<T> onEmptyGet(Supplier<? extends T> supplier) {
       
        return (LazyPBagX<T>)super.onEmptyGet(supplier);
    }
     ...
     */
    @Override
    public <X extends Throwable> LazyPBagX<T> onEmptyThrow(Supplier<? extends X> supplier) {
       
        return (LazyPBagX<T>)super.onEmptyThrow(supplier);
    }
     ...
     */
    @Override
    public LazyPBagX<T> shuffle(Random random) {
       
        return (LazyPBagX<T>)super.shuffle(random);
    }
     ...
     */
    @Override
    public <U> LazyPBagX<U> ofType(Class<? extends U> type) {
       
        return (LazyPBagX<U>)super.ofType(type);
    }
     ...
     */
    @Override
    public LazyPBagX<T> filterNot(Predicate<? super T> fn) {
       
        return (LazyPBagX<T>)super.filterNot(fn);
    }
     ...
     */
    @Override
    public LazyPBagX<T> notNull() {
       
        return (LazyPBagX<T>)super.notNull();
    }
     ...
     */
    @Override
    public LazyPBagX<T> removeAll(Stream<? extends T> stream) {
       
        return (LazyPBagX<T>)(super.removeAll(stream));
    }
     ...
     */
    @Override
    public LazyPBagX<T> removeAll(Seq<? extends T> stream) {
     ...
     */
    @Override
    public LazyPBagX<T> removeAll(Iterable<? extends T> it) {
       
        return (LazyPBagX<T>)super.removeAll(it);
    }
     ...
     */
    @Override
    public LazyPBagX<T> removeAll(T... values) {
       
        return (LazyPBagX<T>)super.removeAll(values);
    }
     ...
     */
    @Override
    public LazyPBagX<T> retainAll(Iterable<? extends T> it) {
       
        return (LazyPBagX<T>)super.retainAll(it);
    }
     ...
     */
    @Override
    public LazyPBagX<T> retainAll(Stream<? extends T> stream) {
       
        return (LazyPBagX<T>)super.retainAll(stream);
    }
     ...
     */
    @Override
    public LazyPBagX<T> retainAll(Seq<? extends T> stream) {
     ...
     */
    @Override
    public LazyPBagX<T> retainAll(T... values) {
       
        return (LazyPBagX<T>)super.retainAll(values);
    }
     ...
     */
    @Override
    public <U> LazyPBagX<U> cast(Class<? extends U> type) {
       
        return (LazyPBagX<U>)super.cast(type);
    }
     ...
     */
    @Override
    public <R> LazyPBagX<R> patternMatch(Function<CheckValue1<T, R>, CheckValue1<T, R>> case1,
            Supplier<? extends R> otherwise) {
       
        return (LazyPBagX<R>)super.patternMatch(case1, otherwise);
    }
     ...
     */
    @Override
    public LazyPBagX<ReactiveSeq<T>> permutations() {
       
        return (LazyPBagX<ReactiveSeq<T>>)super.permutations();
    }
     ...
     */
    @Override
    public LazyPBagX<ReactiveSeq<T>> combinations(int size) {
       
        return (LazyPBagX<ReactiveSeq<T>>)super.combinations(size);
    }
     ...
     */
    @Override
    public LazyPBagX<ReactiveSeq<T>> combinations() {
       
        return (LazyPBagX<ReactiveSeq<T>>)super.combinations();
    }
     ...
     */
    @Override
    public <C extends Collection<? super T>> LazyPBagX<C> grouped(int size, Supplier<C> supplier) {
       
        return (LazyPBagX<C>)super.grouped(size, supplier);
    }
     ...
     */
    @Override
    public LazyPBagX<ListX<T>> groupedUntil(Predicate<? super T> predicate) {
       
        return (LazyPBagX<ListX<T>>)super.groupedUntil(predicate);
    }
     ...
     */
    @Override
    public LazyPBagX<ListX<T>> groupedWhile(Predicate<? super T> predicate) {
       
        return (LazyPBagX<ListX<T>>)super.groupedWhile(predicate);
    }
     ...
     */
    @Override
    public <C extends Collection<? super T>> LazyPBagX<C> groupedWhile(Predicate<? super T> predicate,
            Supplier<C> factory) {
        
        return (LazyPBagX<C>)super.groupedWhile(predicate, factory);
    }
     ...
     */
    @Override
    public <C extends Collection<? super T>> LazyPBagX<C> groupedUntil(Predicate<? super T> predicate,
            Supplier<C> factory) {
        
        return (LazyPBagX<C>)super.groupedUntil(predicate, factory);
    }
     ...
     */
    @Override
    public LazyPBagX<ListX<T>> groupedStatefullyUntil(BiPredicate<ListX<? super T>, ? super T> predicate) {
        
        return (LazyPBagX<ListX<T>>)super.groupedStatefullyUntil(predicate);
    }
     ...
     */
    @Override
    public LazyPBagX<T> peek(Consumer<? super T> c) {
        
        return (LazyPBagX)super.peek(c);
    }
     ...
     */
    @Override
    public <U, R> LazyPBagX<R> zip(Seq<? extends U> other,
     ...
     */
    @Override
    public <U, R> LazyPBagX<R> zip(Stream<? extends U> other,
            BiFunction<? super T, ? super U, ? extends R> zipper) {
     ...
     */
    @Override
    public <U> LazyPBagX<Tuple2<T, U>> zip(Stream<? extends U> other) {
     ...
     */
    @Override
    public <T2, R> LazyPBagX<R> zip(BiFunction<? super T, ? super T2, ? extends R> fn,
            Publisher<? extends T2> publisher) {
       
        return (LazyPBagX<R>)super.zip(fn, publisher);
    }
    ...
    @Override
    public <R> LazyPBagX<R> unit(R value) {
        return singleton(value);
    }

    @Override
    public<R> LazyPBagX<R> unitIterator(Iterator<R> it) {
        return fromIterable(() -> it);
    }

    @Override
    public <R> LazyPBagX<R> emptyUnit() {
       
        return LazyPBagX.<R> empty();
    }

    /**
     * @return This converted to PVector
     */
    public LazyPBagX<T> toPVector() {
        return this;
    }
     ...
     */
    @Override
    public LazyPBagX<T> plusInOrder(T e) {
        return plus(e);
    }
     ...
     */
    @Override
    public <X> LazyPBagX<X> from(Collection<X> col) {
        return fromIterable(col);
    }
    /* (non-Javadoc)
     ...
     */
    @Override
    public <T> Reducer<PBag<T>> monoid() {
     ...
     */
    @Override
    public LazyPBagX<T> plus(T e) {
        return new LazyPBagX<T>(getBag().plus(e),this.collector);
    }
     ...
     */
    @Override
    public  LazyPBagX<T> plusAll(Collection<? extends T> list) {
        return new LazyPBagX<T>(getBag().plusAll(list),this.collector);
    }
     ...
     */
    @Override
    public  LazyPBagX<T> minus(Object e) {
        PCollection<T> res = getBag().minus(e);
