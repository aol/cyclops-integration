...
public class ComprehensionTest {
    ...
    public void optionTest() {
        assertFalse(FJ.ForOption.each2(Option.some(10), a -> Option.none(), (a, b) -> "failed")
                                .isSome());
    }
    ...
    public void option2Test() {
        ...
        assertThat(FJ.ForOption.each2(Option.some(10), a -> Option.<Integer> some(a + 20), (a, b) -> a + b)
                               .option(-1, f -> f),
                   equalTo(40));
    }
