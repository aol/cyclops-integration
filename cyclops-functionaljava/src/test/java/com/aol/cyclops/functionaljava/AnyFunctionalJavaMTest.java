...
public class AnyFunctionalJavaMTest {
    ...
    public void rightProjectionTest() {
        assertThat(FJ.right(Either.right("hello world")
                                  .right())
                     .map(String::toUpperCase)
                     .stream()
                     .toList(),
    ...
    public void rightProjectionLeftTest() {
        assertThat(FJ.right(Either.<String, String> left("hello world")
                                  .right())
                     .map(String::toUpperCase)
                     .toSequence()
                     .toList(),
    ...
    public void leftProjectionLeftTest() {
        assertThat(FJ.left(Either.<String, String> left("hello world")
                                 .left())
                     .map(String::toUpperCase)
                     .toSequence()
                     .toList(),
    ...
    public void ioTest() throws IOException {
        ...
        FJ.unwrapIO(FJ.io(IOFunctions.lazy(a -> {
          ...
          .run();
        assertThat("hello world" + SEP + "hello world2" + SEP, equalTo(sout.getLog()));
    }
}
