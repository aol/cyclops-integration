...
public class JavaslangTest {
    ...
    public void testFromJavaslangλ() {
        assertThat(FromJavaslang.f1((Integer a) -> a * 100)
                                .f(2),
                   is(200));
    ...
    public void testFromJavaslangλ2() {
        assertThat(FromJavaslang.f2((Integer a, Integer b) -> a * b)
                                .f(100, 5),
                   is(500));
    }
    ...
    public void testFromJavaslangOption() {
        assertThat(FromJavaslang.option(Option.of(1))
                                .some(),
                   is(1));
    }
    ...
    public void testFromJavaslangOptionNull() {
        assertThat(FromJavaslang.option(Option.none())
                                .orSome(100),
                   is(100));
    }
    ...
    public void testFromJavaslangEitherLeft() {
        assertThat(FromJavaslang.either(Either.left(1))
                                .left()
                                .value(),
                   is(1));
    }
    ...
    public void testFromJavaslangEitherRight() {
        assertThat(FromJavaslang.either(Either.right(1))
                                .right()
                                .value(),
                   is(1));
    }
