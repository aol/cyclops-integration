...
public interface FJ {
    ...
    public interface ForState {
        ...
        static <S, T, R1, R> State<S, R> each2(State<S, ? extends T> value1,
                Function<? super T, ? extends State<S, R1>> value2,
                BiFunction<? super T, ? super R1, Boolean> filterFunction,
                BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
    ...
    public interface ForEither {
        ...
        static <L, T, R1, R> Either<L, R> each2(Either<L, ? extends T> value1,
                Function<? super T, Either<L, R1>> value2,
                BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
        ...
        static <L, T, R1, R> Either<L, R> each2(Either<L, ? extends T> value1,
                Function<? super T, ? extends Either<L, R1>> value2,
                BiFunction<? super T, ? super R1, Boolean> filterFunction,
                BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
    ...
    public interface ForReader {
        ...
        static <A, T, R1, R> Reader<A, R> each2(Reader<A, ? extends T> value1,
                Function<? super T, Reader<A, R1>> value2,
                BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
        ...
        static <A, T, R1, R> Reader<A, R> each2(Reader<A, ? extends T> value1,
                Function<? super T, ? extends Reader<A, R1>> value2,
                BiFunction<? super T, ? super R1, Boolean> filterFunction,
                BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
    ...
    public interface ForWriter {
        ...
        static <W, T, R1, R> Writer<W, R> each2(Writer<W, ? extends T> value1,
                Function<? super T, Writer<W, R1>> value2,
                BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
        ...
        static <W, T, R1, R> Writer<W, R> each2(Writer<W, ? extends T> value1,
                Function<? super T, ? extends Writer<W, R1>> value2,
                BiFunction<? super T, ? super R1, Boolean> filterFunction,
                BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
    ...
    public interface ForValidation {
        ...
        static <E, T, R1, R> Validation<E, R> each2(Validation<E, ? extends T> value1,
                Function<? super T, Validation<E, R1>> value2,
                BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
        ...
        static <E, T, R1, R> Validation<E, R> each2(Validation<E, ? extends T> value1,
                Function<? super T, ? extends Validation<E, R1>> value2,
                BiFunction<? super T, ? super R1, Boolean> filterFunction,
                BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
    ...
    public interface ForIO {
        ...
        static <T1, T2, R1, R2, R> IO<R> each3(IO<? extends T1> value1, Function<? super T1, ? extends IO<R1>> value2,
                BiFunction<? super T1, ? super R1, ? extends IO<R2>> value3,
                TriFunction<? super T1, ? super R1, ? super R2, ? extends R> yieldingFunction) {
    ...
    public interface ForTrampoline {
        ...
        static <T, R1, R> Trampoline<R> each2(Trampoline<? extends T> value1,
        ...
        static <T, R1, R> Trampoline<R> each2(Trampoline<? extends T> value1,
                Function<? super T, ? extends Trampoline<R1>> value2,
                BiFunction<? super T, ? super R1, Boolean> filterFunction,
                BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
    ...
    public interface ForList {
        ...
        static <T1, T2, T3, R1, R2, R3, R> List<R> each4(List<? extends T1> value1,
            ...
            return AnyM.ofSeq(For.anyM(list(value1))
                                 .anyM(a -> list(value2.apply(a)))
                                 .anyM(a -> b -> list(value3.apply(a, b)))
                                 .anyM(a -> b -> c -> list(value4.apply(a, b, c)))
                                 .yield4(yieldingFunction)
                                 .unwrap())
                       .unwrap();
    ...
    public interface ForStream {
        ...
        static <T1, T2, T3, R1, R2, R3, R> Stream<R> each4(Stream<? extends T1> value1,
            ...
            return AnyM.ofSeq(For.anyM(stream(value1))
                                 .anyM(a -> stream(value2.apply(a)))
                                 .anyM(a -> b -> stream(value3.apply(a, b)))
                                 .anyM(a -> b -> c -> stream(value4.apply(a, b, c)))
                                 .yield4(yieldingFunction)
                                 .unwrap())
                       .unwrap();
    ...
    public interface ForIterableW {
        ...
        static <T1, T2, T3, R1, R2, R3, R> IterableW<R> each4(IterableW<? extends T1> value1,
            ...
            return AnyM.ofSeq(For.anyM(iterableW(value1))
                                 .anyM(a -> iterableW(value2.apply(a)))
                                 .anyM(a -> b -> iterableW(value3.apply(a, b)))
                                 .anyM(a -> b -> c -> iterableW(value4.apply(a, b, c)))
                                 .yield4(yieldingFunction)
                                 .unwrap())
                       .unwrap();
        ...
        static <T, R1, R> IterableW<R> each2(IterableW<? extends T> value1,
                Function<? super T, ? extends IterableW<R1>> value2,
                BiFunction<? super T, ? super R1, Boolean> filterFunction,
                BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
