...
public class DexxPStack<T> extends AbstractList<T>implements PStack<T> {
    ...
    public static <T> LazyLinkedListX<T> fromStream(Stream<T> stream) {
        ...
        return new LazyLinkedListX<T>(null, ReactiveSeq.fromStream(stream), true, r);
    }
    ...
    private static <T> LazyLinkedListX<T> fromPStack(PStack<T> s, Reducer<PStack<T>> pStackReducer) {
        return new LazyLinkedListX<T>(s,null,true, pStackReducer);
    }
    private static <T> LazyLinkedListX<T> fromPStack(PStack<T> s, boolean efficientOps,Reducer<PStack<T>> pStackReducer) {
        return new LazyLinkedListX<T>(s,null,efficientOps, pStackReducer);
    }
