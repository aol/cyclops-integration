...
public class DexxTreeSetX<T> extends AbstractSet<T>implements POrderedSet<T> {
    ...
    public static <T extends Comparable<? super T>> LazyPOrderedSetX<T> fromStream(Stream<T> stream) {
        Reducer<POrderedSet<T>> r = DexxTreeSetX.<T>toPOrderedSet(Comparator.naturalOrder());
    ...
    public static <T extends Comparable<? super T>>  Reducer<POrderedSet<T>> toPOrderedSet() {
        return Reducer.<POrderedSet<T>> of(DexxTreeSetX.emptyPOrderedSet(), (final POrderedSet<T> a) -> b -> a.plusAll(b),
                                      (final T x) -> DexxTreeSetX.singleton(x));
    }
    
    public static <T>  Reducer<POrderedSet<T>> toPOrderedSet(Comparator<T> ordering) {
        return Reducer.<POrderedSet<T>> of(DexxTreeSetX.emptyPOrderedSet(ordering),
    ...
    public static <T> DexxTreeSetX<T> emptyPOrderedSet(Comparator<T> comp) {
    ...
    public static <T extends Comparable<? super T>> LazyPOrderedSetX<T> empty() {
        ...
        return fromPOrderedSet(new DexxTreeSetX<>(new TreeSet<T>(Comparator.naturalOrder())),
                                                toPOrderedSet());
    }
    public static <T> LazyPOrderedSetX<T> empty(Comparator<T> comp) {
        
        return fromPOrderedSet(new DexxTreeSetX<>(new TreeSet<T>(comp)),
                                                toPOrderedSet(comp));
    }
    ...
    public static <T> LazyPOrderedSetX<T> of(Comparator<T> comp,T... t) {
       ...
       return fromPOrderedSet(new DexxTreeSetX<>(
                                                       vec),
                                     toPOrderedSet(comp));
   }
    ...
    public static <T> LazyPOrderedSetX<T> POrderedSet(TreeSet<T> q) {
        ...
        return fromPOrderedSet(new DexxTreeSetX<T>(
                                                         q),
                                      local);
    }
