...
public class DexxHashSetX<T> implements PersistentSet<T>, Unwrapable {
    ...
    public static <T> Reducer<PersistentSet<T>,T> toPSet() {
      return Reducer.fromMonoid(Monoids.pcollectionConcat(HashSet.empty()), a -> DexxHashSetX.singleton(a));
    }
