...
public final class SingleT<W extends WitnessType<W>,T> extends ValueTransformer<W,T>
    ...
    @Override
    public <S, U, R> SingleT<W,R> zip3(Iterable<? extends S> second, Iterable<? extends U> third, Function3<? super T, ? super S, ? super U, ? extends R> fn3) {
    ...
    @Override
    public <T2, T3, T4, R> SingleT<W,R> zip4(Iterable<? extends T2> second, Iterable<? extends T3> third, Iterable<? extends T4> fourth, Function4<? super T, ? super T2, ? super T3, ? super T4, ? extends R> fn) {
