...
public final class FlowableKind<T> implements Higher<FlowableKind.µ, T>, Publisher<T> {
    ...
    public static <T1> Flowable<T1> amb(Iterable<? extends Publisher<? extends T1>> sources) {
        return Flowable.amb(sources);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> ambArray(Publisher<? extends T1>[] sources) {
    ...
    public static <T1, R> Flowable<R> combineLatest(Publisher<? extends T1>[] sources, io.reactivex.functions.Function<? super Object[], ? extends R> combiner) {
    ...
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    public static <T1, R> Flowable<R> combineLatest(Function<? super Object[], ? extends R> combiner, Publisher<? extends T1>[] sources) {
        return Flowable.combineLatest(combiner, sources);
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    public static <T1, R> Flowable<R> combineLatest(Publisher<? extends T1>[] sources, Function<? super Object[], ? extends R> combiner, int bufferSize) {
        return Flowable.combineLatest(sources, combiner, bufferSize);
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    public static <T1, R> Flowable<R> combineLatest(Iterable<? extends Publisher<? extends T1>> sources, Function<? super Object[], ? extends R> combiner) {
        return Flowable.combineLatest(sources, combiner);
    }
    ...
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    public static <T1, R> Flowable<R> combineLatest(Iterable<? extends Publisher<? extends T1>> sources, Function<? super Object[], ? extends R> combiner, int bufferSize) {
        return Flowable.combineLatest(sources, combiner, bufferSize);
    }
    ...
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    public static <T1, R> Flowable<R> combineLatestDelayError(Publisher<? extends T1>[] sources, Function<? super Object[], ? extends R> combiner) {
        return Flowable.combineLatestDelayError(sources, combiner);
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    public static <T1, R> Flowable<R> combineLatestDelayError(Function<? super Object[], ? extends R> combiner, Publisher<? extends T1>[] sources) {
        return Flowable.combineLatestDelayError(combiner, sources);
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    public static <T1, R> Flowable<R> combineLatestDelayError(Function<? super Object[], ? extends R> combiner, int bufferSize, Publisher<? extends T1>[] sources) {
        return Flowable.combineLatestDelayError(combiner, bufferSize, sources);
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    public static <T1, R> Flowable<R> combineLatestDelayError(Publisher<? extends T1>[] sources, Function<? super Object[], ? extends R> combiner, int bufferSize) {
    ...
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    public static <T1, R> Flowable<R> combineLatestDelayError(Iterable<? extends Publisher<? extends T1>> sources, Function<? super Object[], ? extends R> combiner) {
        return Flowable.combineLatestDelayError(sources, combiner);
    }
    ...
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    public static <T1, R> Flowable<R> combineLatestDelayError(Iterable<? extends Publisher<? extends T1>> sources, Function<? super Object[], ? extends R> combiner, int bufferSize) {
        return Flowable.combineLatestDelayError(sources, combiner, bufferSize);
    }
    ...
    public static <T1, T2, T3, R> Flowable<R> combineLatest(Publisher<? extends T1> source1, Publisher<? extends T2> source2, Publisher<? extends T3> source3, Function3<? super T1, ? super T2, ? super T3, ? extends R> combiner) {
        return Flowable.combineLatest(source1, source2, source3, combiner);
    }
    ...
    public static <T1, T2, T3, T4, R> Flowable<R> combineLatest(Publisher<? extends T1> source1, Publisher<? extends T2> source2, Publisher<? extends T3> source3, Publisher<? extends T4> source4, Function4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> combiner) {
        return Flowable.combineLatest(source1, source2, source3, source4, combiner);
    }
    ...
    public static <T1, T2, T3, T4, T5, R> Flowable<R> combineLatest(Publisher<? extends T1> source1, Publisher<? extends T2> source2, Publisher<? extends T3> source3, Publisher<? extends T4> source4, Publisher<? extends T5> source5, Function5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R> combiner) {
        return Flowable.combineLatest(source1, source2, source3, source4, source5, combiner);
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, R> Flowable<R> combineLatest(Publisher<? extends T1> source1, Publisher<? extends T2> source2, Publisher<? extends T3> source3, Publisher<? extends T4> source4, Publisher<? extends T5> source5, Publisher<? extends T6> source6, Function6<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? extends R> combiner) {
        return Flowable.combineLatest(source1, source2, source3, source4, source5, source6, combiner);
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, R> Flowable<R> combineLatest(Publisher<? extends T1> source1, Publisher<? extends T2> source2, Publisher<? extends T3> source3, Publisher<? extends T4> source4, Publisher<? extends T5> source5, Publisher<? extends T6> source6, Publisher<? extends T7> source7, Function7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? extends R> combiner) {
        return Flowable.combineLatest(source1, source2, source3, source4, source5, source6, source7, combiner);
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> Flowable<R> combineLatest(Publisher<? extends T1> source1, Publisher<? extends T2> source2, Publisher<? extends T3> source3, Publisher<? extends T4> source4, Publisher<? extends T5> source5, Publisher<? extends T6> source6, Publisher<? extends T7> source7, Publisher<? extends T8> source8, Function8<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? extends R> combiner) {
        return Flowable.combineLatest(source1, source2, source3, source4, source5, source6, source7, source8, combiner);
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, R> Flowable<R> combineLatest(Publisher<? extends T1> source1, Publisher<? extends T2> source2, Publisher<? extends T3> source3, Publisher<? extends T4> source4, Publisher<? extends T5> source5, Publisher<? extends T6> source6, Publisher<? extends T7> source7, Publisher<? extends T8> source8, Publisher<? extends T9> source9, Function9<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? extends R> combiner) {
        return Flowable.combineLatest(source1, source2, source3, source4, source5, source6, source7, source8, source9, combiner);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> concat(Iterable<? extends Publisher<? extends T1>> sources) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> concat(Publisher<? extends Publisher<? extends T1>> sources) {
        return Flowable.concat(sources);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> concat(Publisher<? extends Publisher<? extends T1>> sources, int prefetch) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> concat(Publisher<? extends T1> source1, Publisher<? extends T1> source2) {
        return Flowable.concat(source1, source2);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> concat(Publisher<? extends T1> source1, Publisher<? extends T1> source2, Publisher<? extends T1> source3) {
        return Flowable.concat(source1, source2, source3);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> concat(Publisher<? extends T1> source1, Publisher<? extends T1> source2, Publisher<? extends T1> source3, Publisher<? extends T1> source4) {
        return Flowable.concat(source1, source2, source3, source4);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> concatArray(Publisher<? extends T1>[] sources) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> concatArrayDelayError(Publisher<? extends T1>[] sources) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> concatArrayEager(Publisher<? extends T1>[] sources) {
        return Flowable.concatArrayEager(sources);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> concatArrayEager(int maxConcurrency, int prefetch, Publisher<? extends T1>[] sources) {
        return Flowable.concatArrayEager(maxConcurrency, prefetch, sources);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> concatDelayError(Iterable<? extends Publisher<? extends T1>> sources) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> concatDelayError(Publisher<? extends Publisher<? extends T1>> sources) {
        return Flowable.concatDelayError(sources);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> concatDelayError(Publisher<? extends Publisher<? extends T1>> sources, int prefetch, boolean tillTheEnd) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> concatEager(Publisher<? extends Publisher<? extends T1>> sources) {
        return Flowable.concatEager(sources);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> concatEager(Publisher<? extends Publisher<? extends T1>> sources, int maxConcurrency, int prefetch) {
        return Flowable.concatEager(sources, maxConcurrency, prefetch);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> concatEager(Iterable<? extends Publisher<? extends T1>> sources) {
        return Flowable.concatEager(sources);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> concatEager(Iterable<? extends Publisher<? extends T1>> sources, int maxConcurrency, int prefetch) {
        return Flowable.concatEager(sources, maxConcurrency, prefetch);
    }
    ...
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> create(FlowableOnSubscribe<T1> source, BackpressureStrategy mode) {
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> defer(Callable<? extends Publisher<? extends T1>> supplier) {
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> error(Callable<? extends Throwable> supplier) {
        return Flowable.error(supplier);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> error(Throwable throwable) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> fromArray(T1[] items) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> fromCallable(Callable<? extends T1> supplier) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> fromFuture(Future<? extends T1> future) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> fromFuture(Future<? extends T1> future, long timeout, TimeUnit unit) {
        return Flowable.fromFuture(future, timeout, unit);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("custom")
    public static <T1> Flowable<T1> fromFuture(Future<? extends T1> future, long timeout, TimeUnit unit, io.reactivex.Scheduler scheduler) {
        return Flowable.fromFuture(future, timeout, unit, scheduler);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("custom")
    public static <T1> Flowable<T1> fromFuture(Future<? extends T1> future, io.reactivex.Scheduler scheduler) {
        return Flowable.fromFuture(future, scheduler);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> fromIterable(Iterable<? extends T1> source) {
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> fromPublisher(Publisher<? extends T1> source) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> generate(Consumer<Emitter<T1>> generator) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1, S> Flowable<T1> generate(Callable<S> initialState, BiConsumer<S, Emitter<T1>> generator) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1, S> Flowable<T1> generate(Callable<S> initialState, BiConsumer<S, Emitter<T1>> generator, Consumer<? super S> disposeState) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1, S> Flowable<T1> generate(Callable<S> initialState, BiFunction<S, Emitter<T1>, S> generator) {
        return Flowable.generate(initialState, generator);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1, S> Flowable<T1> generate(Callable<S> initialState, BiFunction<S, Emitter<T1>, S> generator, Consumer<? super S> disposeState) {
        return Flowable.generate(initialState, generator, disposeState);
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @SchedulerSupport("custom")
    public static Flowable<Long> interval(long initialDelay, long period, TimeUnit unit, io.reactivex.Scheduler scheduler) {
        return Flowable.interval(initialDelay, period, unit, scheduler);
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @SchedulerSupport("custom")
    public static Flowable<Long> interval(long period, TimeUnit unit, io.reactivex.Scheduler scheduler) {
        return Flowable.interval(period, unit, scheduler);
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @SchedulerSupport("custom")
    public static Flowable<Long> intervalRange(long start, long count, long initialDelay, long period, TimeUnit unit, io.reactivex.Scheduler scheduler) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> just(T1 item1, T1 item2) {
        return Flowable.just(item1, item2);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> just(T1 item1, T1 item2, T1 item3) {
        return Flowable.just(item1, item2, item3);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> just(T1 item1, T1 item2, T1 item3, T1 item4) {
        return Flowable.just(item1, item2, item3, item4);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> just(T1 item1, T1 item2, T1 item3, T1 item4, T1 item5) {
        return Flowable.just(item1, item2, item3, item4, item5);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> just(T1 item1, T1 item2, T1 item3, T1 item4, T1 item5, T1 item6) {
        return Flowable.just(item1, item2, item3, item4, item5, item6);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> just(T1 item1, T1 item2, T1 item3, T1 item4, T1 item5, T1 item6, T1 item7) {
        return Flowable.just(item1, item2, item3, item4, item5, item6, item7);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> just(T1 item1, T1 item2, T1 item3, T1 item4, T1 item5, T1 item6, T1 item7, T1 item8) {
        return Flowable.just(item1, item2, item3, item4, item5, item6, item7, item8);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> just(T1 item1, T1 item2, T1 item3, T1 item4, T1 item5, T1 item6, T1 item7, T1 item8, T1 item9) {
        return Flowable.just(item1, item2, item3, item4, item5, item6, item7, item8, item9);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> just(T1 item1, T1 item2, T1 item3, T1 item4, T1 item5, T1 item6, T1 item7, T1 item8, T1 item9, T1 item10) {
        return Flowable.just(item1, item2, item3, item4, item5, item6, item7, item8, item9, item10);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> merge(Iterable<? extends Publisher<? extends T1>> sources, int maxConcurrency, int bufferSize) {
        return Flowable.merge(sources, maxConcurrency, bufferSize);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> mergeArray(int maxConcurrency, int bufferSize, Publisher<? extends T1>[] sources) {
        return Flowable.mergeArray(maxConcurrency, bufferSize, sources);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> merge(Iterable<? extends Publisher<? extends T1>> sources) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> merge(Iterable<? extends Publisher<? extends T1>> sources, int maxConcurrency) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> merge(Publisher<? extends Publisher<? extends T1>> sources) {
        return Flowable.merge(sources);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> merge(Publisher<? extends Publisher<? extends T1>> sources, int maxConcurrency) {
        return Flowable.merge(sources, maxConcurrency);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> mergeArray(Publisher<? extends T1>[] sources) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> merge(Publisher<? extends T1> source1, Publisher<? extends T1> source2) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> merge(Publisher<? extends T1> source1, Publisher<? extends T1> source2, Publisher<? extends T1> source3) {
        return Flowable.merge(source1, source2, source3);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> merge(Publisher<? extends T1> source1, Publisher<? extends T1> source2, Publisher<? extends T1> source3, Publisher<? extends T1> source4) {
        return Flowable.merge(source1, source2, source3, source4);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> mergeDelayError(Iterable<? extends Publisher<? extends T1>> sources) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> mergeDelayError(Iterable<? extends Publisher<? extends T1>> sources, int maxConcurrency, int bufferSize) {
        return Flowable.mergeDelayError(sources, maxConcurrency, bufferSize);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> mergeArrayDelayError(int maxConcurrency, int bufferSize, Publisher<? extends T1>[] sources) {
        return Flowable.mergeArrayDelayError(maxConcurrency, bufferSize, sources);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> mergeDelayError(Iterable<? extends Publisher<? extends T1>> sources, int maxConcurrency) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> mergeDelayError(Publisher<? extends Publisher<? extends T1>> sources) {
        return Flowable.mergeDelayError(sources);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> mergeDelayError(Publisher<? extends Publisher<? extends T1>> sources, int maxConcurrency) {
        return Flowable.mergeDelayError(sources, maxConcurrency);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> mergeArrayDelayError(Publisher<? extends T1>[] sources) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> mergeDelayError(Publisher<? extends T1> source1, Publisher<? extends T1> source2) {
        return Flowable.mergeDelayError(source1, source2);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> mergeDelayError(Publisher<? extends T1> source1, Publisher<? extends T1> source2, Publisher<? extends T1> source3) {
        return Flowable.mergeDelayError(source1, source2, source3);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> mergeDelayError(Publisher<? extends T1> source1, Publisher<? extends T1> source2, Publisher<? extends T1> source3, Publisher<? extends T1> source4) {
        return Flowable.mergeDelayError(source1, source2, source3, source4);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> never() {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Single<Boolean> sequenceEqual(Publisher<? extends T1> source1, Publisher<? extends T1> source2) {
        return Flowable.sequenceEqual(source1, source2);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Single<Boolean> sequenceEqual(Publisher<? extends T1> source1, Publisher<? extends T1> source2, BiPredicate<? super T1, ? super T1> isEqual) {
        return Flowable.sequenceEqual(source1, source2, isEqual);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Single<Boolean> sequenceEqual(Publisher<? extends T1> source1, Publisher<? extends T1> source2, BiPredicate<? super T1, ? super T1> isEqual, int bufferSize) {
        return Flowable.sequenceEqual(source1, source2, isEqual, bufferSize);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Single<Boolean> sequenceEqual(Publisher<? extends T1> source1, Publisher<? extends T1> source2, int bufferSize) {
        return Flowable.sequenceEqual(source1, source2, bufferSize);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> switchOnNext(Publisher<? extends Publisher<? extends T1>> sources, int bufferSize) {
        return Flowable.switchOnNext(sources, bufferSize);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> switchOnNext(Publisher<? extends Publisher<? extends T1>> sources) {
        return Flowable.switchOnNext(sources);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> switchOnNextDelayError(Publisher<? extends Publisher<? extends T1>> sources) {
        return Flowable.switchOnNextDelayError(sources);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> switchOnNextDelayError(Publisher<? extends Publisher<? extends T1>> sources, int prefetch) {
        return Flowable.switchOnNextDelayError(sources, prefetch);
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @SchedulerSupport("custom")
    public static Flowable<Long> timer(long delay, TimeUnit unit, io.reactivex.Scheduler scheduler) {
    ...
    @SchedulerSupport("none")
    public static <T1> Flowable<T1> unsafeCreate(Publisher<T1> onSubscribe) {
        return Flowable.unsafeCreate(onSubscribe);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @SchedulerSupport("none")
    public static <T1, D> Flowable<T1> using(Callable<? extends D> resourceSupplier, Function<? super D, ? extends Publisher<? extends T1>> sourceSupplier, Consumer<? super D> resourceDisposer) {
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @SchedulerSupport("none")
    public static <T1, D> Flowable<T1> using(Callable<? extends D> resourceSupplier, Function<? super D, ? extends Publisher<? extends T1>> sourceSupplier, Consumer<? super D> resourceDisposer, boolean eager) {
        return Flowable.using(resourceSupplier, sourceSupplier, resourceDisposer, eager);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1, R> Flowable<R> zip(Iterable<? extends Publisher<? extends T1>> sources, Function<? super Object[], ? extends R> zipper) {
        return Flowable.zip(sources, zipper);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1, R> Flowable<R> zip(Publisher<? extends Publisher<? extends T1>> sources, Function<? super Object[], ? extends R> zipper) {
        return Flowable.zip(sources, zipper);
    }
    ...
    public static <T1, T2, R> Flowable<R> zip(Publisher<? extends T1> source1, Publisher<? extends T2> source2, BiFunction<? super T1, ? super T2, ? extends R> zipper, boolean delayError) {
        return Flowable.zip(source1, source2, zipper, delayError);
    }
    ...
    public static <T1, T2, R> Flowable<R> zip(Publisher<? extends T1> source1, Publisher<? extends T2> source2, BiFunction<? super T1, ? super T2, ? extends R> zipper, boolean delayError, int bufferSize) {
        return Flowable.zip(source1, source2, zipper, delayError, bufferSize);
    }
    ...
    public static <T1, T2, T3, R> Flowable<R> zip(Publisher<? extends T1> source1, Publisher<? extends T2> source2, Publisher<? extends T3> source3, Function3<? super T1, ? super T2, ? super T3, ? extends R> zipper) {
        return Flowable.zip(source1, source2, source3, zipper);
    }
    ...
    public static <T1, T2, T3, T4, R> Flowable<R> zip(Publisher<? extends T1> source1, Publisher<? extends T2> source2, Publisher<? extends T3> source3, Publisher<? extends T4> source4, Function4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> zipper) {
        return Flowable.zip(source1, source2, source3, source4, zipper);
    }
    ...
    public static <T1, T2, T3, T4, T5, R> Flowable<R> zip(Publisher<? extends T1> source1, Publisher<? extends T2> source2, Publisher<? extends T3> source3, Publisher<? extends T4> source4, Publisher<? extends T5> source5, Function5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R> zipper) {
        return Flowable.zip(source1, source2, source3, source4, source5, zipper);
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, R> Flowable<R> zip(Publisher<? extends T1> source1, Publisher<? extends T2> source2, Publisher<? extends T3> source3, Publisher<? extends T4> source4, Publisher<? extends T5> source5, Publisher<? extends T6> source6, Function6<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? extends R> zipper) {
        return Flowable.zip(source1, source2, source3, source4, source5, source6, zipper);
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, R> Flowable<R> zip(Publisher<? extends T1> source1, Publisher<? extends T2> source2, Publisher<? extends T3> source3, Publisher<? extends T4> source4, Publisher<? extends T5> source5, Publisher<? extends T6> source6, Publisher<? extends T7> source7, Function7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? extends R> zipper) {
        return Flowable.zip(source1, source2, source3, source4, source5, source6, source7, zipper);
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> Flowable<R> zip(Publisher<? extends T1> source1, Publisher<? extends T2> source2, Publisher<? extends T3> source3, Publisher<? extends T4> source4, Publisher<? extends T5> source5, Publisher<? extends T6> source6, Publisher<? extends T7> source7, Publisher<? extends T8> source8, Function8<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? extends R> zipper) {
        return Flowable.zip(source1, source2, source3, source4, source5, source6, source7, source8, zipper);
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, R> Flowable<R> zip(Publisher<? extends T1> source1, Publisher<? extends T2> source2, Publisher<? extends T3> source3, Publisher<? extends T4> source4, Publisher<? extends T5> source5, Publisher<? extends T6> source6, Publisher<? extends T7> source7, Publisher<? extends T8> source8, Publisher<? extends T9> source9, Function9<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? extends R> zipper) {
        return Flowable.zip(source1, source2, source3, source4, source5, source6, source7, source8, source9, zipper);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1, R> Flowable<R> zipArray(Function<? super Object[], ? extends R> zipper, boolean delayError, int bufferSize, Publisher<? extends T1>[] sources) {
        return Flowable.zipArray(zipper, delayError, bufferSize, sources);
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T1, R> Flowable<R> zipIterable(Iterable<? extends Publisher<? extends T1>> sources, Function<? super Object[], ? extends R> zipper, boolean delayError, int bufferSize) {
        return Flowable.zipIterable(sources, zipper, delayError, bufferSize);
    }
