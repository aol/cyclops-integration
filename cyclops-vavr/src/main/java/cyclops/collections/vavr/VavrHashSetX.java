...
public class VavrHashSetX<T> extends AbstractSet<T> implements PersistentSet<T>, Unwrapable {
     ...
     * <pre>
     * {@code
     * PersistentSet<Integer> q = VavrHashSetX.<Integer>toPSet()
    ...
    public static <T> Reducer<PersistentSet<T>> toPSet() {
        return Reducer.<PersistentSet<T>> of(VavrHashSetX.emptyPSet(), (final PersistentSet<T> a) -> b -> a.plusAll(b), (final T x) -> VavrHashSetX.singleton(x));
    }
