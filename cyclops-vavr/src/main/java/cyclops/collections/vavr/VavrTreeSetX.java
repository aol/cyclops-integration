...
public class VavrTreeSetX<T> implements PersistentSortedSet<T>, Unwrapable {
    ...
    public static <T extends Comparable<? super T>> LazyPersistentSortedSetX<T> fromStream(Stream<T> stream) {
        return new LazyPersistentSortedSetX<T>(null,ReactiveSeq.fromStream(stream), toPersistentSortedSet(), Evaluation.LAZY);
    }
    public static <T> LazyPersistentSortedSetX<T> fromStream(Stream<T> stream,Comparator<? super T> c) {
        return new LazyPersistentSortedSetX<T>(null,ReactiveSeq.fromStream(stream), toPersistentSortedSet(c), Evaluation.LAZY);
    }
     ...
     */
    public static <U, T extends Comparable<? super T>> LazyPersistentSortedSetX<T> unfold(U seed, Function<? super U, Option<Tuple2<T, U>>> unfolder) {
    ...
    public static <T> LazyPersistentSortedSetX<T> empty(Comparator<? super T> comparator) {
        return fromPersistentSortedSet(new VavrTreeSetX<T>(
    ...
    public static <T>  LazyPersistentSortedSetX<T> singleton(Comparator<? super T> comparator,T t) {
        return fromPersistentSortedSet(new VavrTreeSetX<T>(
    ...
    public static <T> LazyPersistentSortedSetX<T> ofAll(SortedSet<T> set) {
        return fromPersistentSortedSet(new VavrTreeSetX<>(set), toPersistentSortedSet(set.comparator()));
    }
    public static <T> LazyPersistentSortedSetX<T> PersistentSortedSet(SortedSet<T> set) {
        return fromPersistentSortedSet(new VavrTreeSetX<>(set), toPersistentSortedSet(set.comparator()));
    }
