...
public class EvalsTest {
    ...
    public void unit(){
        ...
        EvalType<String> opt = Evals.unit()
                                            .unit("hello")
    ...
    public void functor(){
        ...
        EvalType<Integer> opt = Evals.unit()
                                     .unit("hello")
    ...
    public void applicative(){
        ...
        EvalType<Function<Integer,Integer>> optFn =Evals.unit().unit(Lambda.l1((Integer i) ->i*2)).convert(EvalType::narrowK);
        
        EvalType<Integer> opt = Evals.unit()
                                     .unit("hello")
                                     .then(h->Evals.functor().map((String v) ->v.length(), h))
                                     .then(h->Evals.applicative().ap(optFn, h))
                                     .convert(EvalType::narrowK);
    ...
    public void monadSimple(){
       EvalType<Integer> opt  = Evals.monad()
    ...
    public void monadPlus(){
        EvalType<Integer> opt = Evals.<Integer>monadPlus()
    ...
    public void monadPlusNonEmpty(){
        ...
        EvalType<Integer> opt = Evals.<Integer>monadPlus(m)
